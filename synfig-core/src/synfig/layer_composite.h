...
protected:
	...
	Layer_Composite(float amount=1.0f, Color::BlendMethod blend_method=Color::BLEND_COMPOSITE);
...
public:
	...
	virtual bool is_solid_color()const { return param_amount.get(float())==1.0f && blend_method==Color::BLEND_STRAIGHT; }
